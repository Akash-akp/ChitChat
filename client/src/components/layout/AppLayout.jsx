            ...
            <div className="flex bg-lightdarkgray w-[100vw] ">
                <div className="w-[80px] h-[95vh] bg-gray-800 my-[2.5vh] ml-6 rounded-xl flex flex-col relative items-center justify-between">
                    ...
                    <div className="flex flex-col gap-[50px]">
                        ...
                        {chatIconState?(
                            <img src={chatSolidIcon} className="scale-150 cursor-pointer" onClick={()=>navigate("/chat")}/>
                        ):(
                            <img src={chatIcon} className="scale-150 cursor-pointer" onClick={()=>navigate("/chat")} />
                        )}
                        {notificationIconState?(
                            <img src={heartSolidIcon} className="scale-150 cursor-pointer" />
                        ):(
                            <img src={heartIcon} className="scale-150 cursor-pointer" onClick={()=>navigate("/notification")} />
                        )}
